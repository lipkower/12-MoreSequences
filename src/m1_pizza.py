...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(120.0, 45),
                rg.Point(107.5, 66.7),
                rg.Point(82.5, 66.7),
                rg.Point(70, 45),
                rg.Point(82.5, 23.5),
                rg.Point(107.5, 23.3)]
    circle = rg.Circle(rg.Point(95, 45), 25)
    answer = generate_points_on_circle(circle, 6)
...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 1:  9 orange dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.fill_color = 'red'
    draw_points_on_circle(window, circle, 9, 'orange')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # Test 4
    title = 'PIZZA test 4: 26 black slices on a yellow circle.'
    window = rg.RoseWindow(450, 450, title)
    circle = rg.Circle(rg.Point(225, 225), 150)
    circle.fill_color = 'yellow'
    pizza(window, circle, 35, 'black', 1)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    # Test 4
    title = 'FANCY POLYGON test 4:  12 teal lines, hops = 5;'
    window = rg.RoseWindow(520, 450, title)

    circle = rg.Circle(rg.Point(150, 150), 90)
    fancy_polygon(window, circle, 12, 5, 'teal', 6)
    window.continue_on_mouse_click()
