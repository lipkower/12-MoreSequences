...
def run_test_make_simple_list():
    ...
    expected = [66, 67, 68, 69, 70, 71]
    actual = make_simple_list(66, 71)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    actual = make_less_simple_string(5, 11)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_less_simple_string(m, n):
    ...
    # -------------------------------------------------------------------------
    numbers = ''
    numbers = numbers + str(m)
    for k in range(m + 2, n + 2):
        numbers = numbers + str(-k + 1)
    return numbers
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        rectangle = rg.Rectangle(rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y -
                                          circles[k].radius), rg.Point(circles[k].center.x + circles[k].radius,
